...
var BTree = function(order){
	...
	tree.root = null;
	tree.order = order;
	//actual desplazamiento de hoja (altura del arbol)
	tree.current_leaf_offset = 0;
	//array para nodos no vinculados sobre hojas desplazadas
	tree.unattached_nodes = [[]];
	//forma de entrar al debugger
	if (tree.order < 3) {
...
//agregar a historial de nodos desvinculados especificado por nivel del arbol
...
//remover del historial de nodos desvinculados (childre) especificado por nivel del arbol
