...
//construye un array incializado con null
...
//Nodo: inicializado con claves e hijos
function BTreeNode() {
	this._keyCount = 0;
...
//booleano de condicion de hoja
//si no tiene hijos el actual nodo
BTreeNode.prototype.isLeaf = function() {
	return (this._childs[0] === null);
};


//el minimo nro de claves admitidas es t-1
//si es t supera en en uno y es considerado nodo lleno
BTreeNode.prototype.isFull = function() {
	return (this._keyCount === NKEYS);
};

//retorna el nro de claves actuales en el nodo
...
BTreeNode.prototype.add = function(key) {
	if (this.isLeaf()) {
		...
		//en caso de ser un nodo intermedio
		var child = this.getChildContaining(key);
		
		//agregar clave dividir
